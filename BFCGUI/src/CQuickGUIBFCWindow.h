...
BFC_GUI_CLASS CQuickGUIBFCWindow
{                                // Macro for class hierarchy declarations
	friend class UILayerWindow;
	friend class GetlineWindow;

public:
  // CQuickGUIBFCWindow's constructor
	CQuickGUIBFCWindow(const EBFC_GUI_WINDOW_TYPE eType, FXApp *p_App, UILayerWindow* p_Layer);
	virtual ~CQuickGUIBFCWindow();
  // Initialize
...
protected:
	QuickGUI::Window					* mWin;
	QuickGUI::Sheet						* mSheet;
	QuickGUI::Panel						* mControlPanel;
	QuickGUI::LabelDesc				* labelDesc;
	QuickGUI::ButtonDesc				* bd;
	QuickGUI::TextBoxDesc			* tbd;
	QuickGUI::CheckBoxDesc		* cbd;
	QuickGUI::DescManager			* dm ;
...
BFC_GUI_CLASS CFoxTopWindow : public CQuickGUIBFCWindow, public FXTopWindow
{
...
BFC_GUI_CLASS CFoxChildWindow : public CQuickGUIBFCWindow,  public FXComposite
{
...
BFC_GUI_CLASS CFoxMainWindow : public CQuickGUIBFCWindow, public FXMainWindow
{
...
BFC_GUI_CLASS CFoxDialogWindow : public CQuickGUIBFCWindow, public FXDialogBox
{
...
BFC_GUI_CLASS CFoxButtonWindow : public CQuickGUIBFCWindow, public QuickGUI::Button
{
...
BFC_GUI_CLASS CFoxTextWindow : public CQuickGUIBFCWindow, public QuickGUI::Label
{
...
BFC_GUI_CLASS CFoxTextboxWindow : public CQuickGUIBFCWindow, public FXTextField
{
...
BFC_GUI_CLASS CFoxLabelWindow : public CQuickGUIBFCWindow, public FXLabel
{
...
BFC_GUI_CLASS CFoxListWindow : public CQuickGUIBFCWindow, public QuickGUI::Label
{
...
BFC_GUI_CLASS CFoxListboxWindow : public CQuickGUIBFCWindow, public QuickGUI::ListBox
{
...
BFC_GUI_CLASS CFoxComboWindow : public CQuickGUIBFCWindow, public FXComboBox
{
