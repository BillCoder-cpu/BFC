...
BFC_GUI_CLASS DX	// old style - here for older compatability , don't use this!
{
public:
	DX();
	virtual ~DX();
	...
	virtual bool GetSetText ( const STRING &csName, STRING &csText, const bool bSet=false ) const;
...
BFC_GUI_CLASS DataExchange : public DX
{
public:
	DataExchange();
...
{
	public:
		DataSource() : m_pDX ( NULL ) {}
		void SetDX ( DX *pDX ) { m_pDX=pDX; }
//		virtual bool Acquire (DataExchange *p_DX);
	protected:
		DX	*	GetDX() const { return m_pDX; }
